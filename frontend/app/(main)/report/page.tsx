...
import { IncidentInfoForm } from "@/components/forms/incident-info-form"
    ...
    <div>
      ...
      <main className="container mx-auto px-4 pb-8">
        ...
        <div className="max-w-4xl mx-auto">
          {currentStep === 1 && (
            <>
              <ReporterInfoForm data={formData} onChange={updateField} />
          ...
          {currentStep === 2 && (
            <>
              <IncidentInfoForm data={formData} onChange={updateField} />
