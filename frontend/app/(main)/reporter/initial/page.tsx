...
export default function InitialEvidenceForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const initialEvidence = JSON.parse(sessionStorage.getItem('initialEvidence') || '[]')
    const newEvidence = {
  ...
  return (
    <Card className="max-w-4xl mx-auto mt-10 bg-white p-8 rounded-xl shadow-lg">
      <CardContent>
        <h2 className="text-2xl font-bold text-center mb-2">Initial Evidence</h2>
        <p className="text-sm text-muted-foreground text-center mb-6">
          This form is used to document physical evidence collected at the scene.
        </p>

        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="evidenceType" className="mb-2 block">Types of Evidence *</Label>
            ...
            <div>
              <Label htmlFor="location" className="mb-2 block">Evidence Location *</Label>
              <Input
                id="location"
                name="location"
                placeholder="E.g., At the scene, in the car..."
