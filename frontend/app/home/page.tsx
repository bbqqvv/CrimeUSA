        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Tell us what happened.</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Your contribution & our mission.</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Protect yourself and others.</h3>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="h-48 bg-gradient-to-r from-red-500 via-orange-500 via-cyan-500 to-yellow-500 flex items-center justify-center">
                <div className="text-white text-center">
                  <div className="space-y-2">
                    <div className="bg-red-600 text-white px-4 py-2 transform -rotate-12">COMPUTER</div>
                    <div className="bg-orange-500 text-white px-4 py-2 transform rotate-12">ROBBERIES</div>
                    <div className="bg-cyan-500 text-white px-4 py-2 transform -rotate-12">STATISTICS</div>
                    <div className="bg-yellow-500 text-white px-4 py-2 transform rotate-12">BURGLARY</div>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-4 text-blue-600">CompStat & Crime Stats</h3>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-4 text-blue-600">Body-worn Cameras</h3>
                <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-4 text-blue-600">Help Is Available</h3>
                <p className="text-gray-600">
