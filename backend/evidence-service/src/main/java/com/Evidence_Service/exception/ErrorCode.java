...
public enum ErrorCode {
    ...
    METHOD_NOT_ALLOWED(9004, "METHOD_NOT_ALLOWED", HttpStatus.METHOD_NOT_ALLOWED ),
    UNSUPPORTED_MEDIA_TYPE(9005, "UNSUPPORTED_MEDIA_TYPE", HttpStatus.UNSUPPORTED_MEDIA_TYPE),
    NOT_FOUND(404, "NOT_FOUND", HttpStatus.NOT_FOUND),
    RECORD_INFO_NOT_FOUND(4004, "RECORD_INFO_NOT_FOUND" , HttpStatus.NOT_FOUND),
    DIGITAL_INVEST_RESULT_NOT_FOUND(100, "abc", HttpStatus.NOT_FOUND),
    FORENSIC_INVEST_RESULT_NOT_FOUND(101, "abc", HttpStatus.NOT_FOUND),
    FINANCIAL_INVEST_RESULT_NOT_FOUND(111, "abc", HttpStatus.NOT_FOUND),
    PHYSICAL_INVEST_RESULT_NOT_FOUND(112, "abc", HttpStatus.NOT_FOUND),
    MEASURE_SURVEY_NOT_FOUND(113, "abc", HttpStatus.NOT_FOUND),
    INTERNAL_SERVER_ERROR(9999, "123", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    FILE_TOO_LARGE(1401, "File size exceeds limit", HttpStatus.BAD_REQUEST),
