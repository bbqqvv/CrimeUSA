...
public class PhysicalInvestResultController {
    ...
    public ApiResponse<PhysicalInvestResultDTO> createPhysicalInvestResult(@Valid  @PathVariable String evidenceId, @RequestBody PhysicalInvestResultDTO dto) {
    ...
    public ApiResponse<Page<PhysicalInvestResultDTO>> getAllPhysicalInvestResults(@Valid @PathVariable String evidenceId,
    ...
    public ApiResponse<PhysicalInvestResultDTO> getPhysicalInvestResultById(@Valid @PathVariable String resultId) {
    ...
    public ApiResponse<PhysicalInvestResultDTO> updatePhysicalInvestResult(@Valid @PathVariable String evidenceId, @PathVariable String resultId, @RequestBody PhysicalInvestResultDTO dto) {
